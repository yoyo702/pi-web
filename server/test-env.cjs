...
// never write the user's ~/.pi-web/notifications.json or push.json, and the Claude session
...
if (inherited) { delete process.env.PI_WEB_NOTIFICATIONS_FILE; delete process.env.PI_WEB_PUSH_FILE; delete process.env.CLAUDE_CONFIG_DIR; }
