...
function handleRequest(req, res) {
  ...
  const terminalHookApi = require("./terminal-hook-api.cjs");
  if (terminalHookApi.isPath(url.pathname)) return terminalHookApi.handle(req, res, { isLocalAddress: (name) => getLocalHostNames().has(name) });
