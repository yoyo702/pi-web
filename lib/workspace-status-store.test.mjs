...
test("starts empty and applies known messages only", () => {
  ...
  assert.deepEqual(store.getSnapshot(), { runningSessionIds: null, terminals: null, terminalLimits: null, codexRuntimes: null, notifications: null, unreadNotifications: 0 });
