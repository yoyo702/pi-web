...
export default defineConfig({
  ...
  webServer: {
    command: "PI_WEB_E2E=1 PI_WEB_ALLOWED_ROOTS_FILE=/tmp/pi-web-e2e-allowed-roots.json PI_WEB_NOTIFICATIONS_FILE=/tmp/pi-web-e2e-notifications.json PI_WEB_PUSH_FILE=/tmp/pi-web-e2e-push.json PI_WEB_NEXT_DIST_DIR=.next-e2e NEXT_PUBLIC_DISABLE_AGENTATION=1 node server/pi-web-server.js dev -H 127.0.0.1 -p 30142",
